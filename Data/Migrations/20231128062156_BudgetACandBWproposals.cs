...
{
    /// <inheritdoc />
    public partial class BudgetACandBWproposals : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ACandBWproposals", x => new { x.DivisionID, x.FinancialYear1, x.FinancialYear2, x.SectionNumber, x.GroupNumber, x.SubGroupNumber, x.LedgerNumber });
                });
        }
